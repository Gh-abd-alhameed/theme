...
<section class="best-modified-cars" style="background-color: #0d0d19;">
	<div class="container text-center pt-5">
		<h1 class=" fw-bold" style="color:#8016A5;">Shop Modified Cars</h1>
			...
			if (woocommerce_product_loop()) {
				...
				if (wc_get_loop_prop('total')) {
					while (have_posts()) {
						...
						wc_get_template_part( 'content', 'product' ); // template woocommerce default
					}
				}

				woocommerce_product_loop_end();// </ul> after shop loop
