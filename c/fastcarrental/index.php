                ...
                <form class="col-lg-12" action="" method="get">
                    <div class="row">
                        ...
                        <div class="col-lg-4   mx-auto  ">
                            ...
                            <input type="text" class="form-control" id="yournumber" placeholder="Your Number"
                        ...
                        <div class="col-lg-4   mx-auto ">
                            <label class="color-white pb-3" for="yourfavourite">Choose your favourite car *</label>
                            <input type="text" class="form-control" id="yourfavourite" placeholder="Your Number"
                                aria-label="Last name">
                        </div>
                        ...
                        <div class="col-lg-12 text-start  ">
                            ...
                            <input type="text" class="form-control" id="" placeholder="Your Message"
                                aria-label="Last name" rows="3">
                        </div>
                        <div>
                </form>
            </div>
        ...
        <div class="container text-center pt-5 pb-5">
            ...
            <div class="row ">
                <div class="col-lg-3 text-center  ">
                    <img src="/image/icon7.webp " style="width:65px;height:65;" alt="">
                ...
                <div class="col-lg-3 text-center" style="border-left: 2px solid white;">
                    <img src="/image/icon8.webp " style="width:65px;height:65;" alt="">
                ...
                <div class="col-lg-3 text-center  " style=" border-left: 2px solid white;">
                    ...
                    <img src="/image/icon9.webp " style="width:65px;height:65;" alt="">
                ...
                <div class="col-lg-3 text-center  " style=" border-left: 2px solid white;">
                    ...
                    <img src="/image/icon10.webp " style="width:65px;height:65;" alt="">
        ...
        <div class="container text-center pt-5 pb-5">
            <div class="row">
                ...
                <div class="col-lg-6 pe-3 ">
                    <div class="scale">
                        <img src="/image/s1.webp" class="img-fluid" alt="">
                    </div>
                ...
                <div class="col-lg-6 ps-3 ">
                    <div class="scale">
                        <img src="/image/luxury-in-a-limousine.webp" class="img-fluid" alt="">
                    </div>
                ...
                <div class="col-lg-6 pe-3 ">
                    <div class="scale">
                        <img src="/image/plane.webp" class="img-fluid" alt="">
                    </div>
                ...
                <div class="col-lg-6 ps-3 ">
                    <div class="scale">
                        <img src="/image/monthly-deal.webp" class="img-fluid" alt="">
                    </div>
